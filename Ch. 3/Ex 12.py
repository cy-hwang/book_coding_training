...
# 도전과제
  ...
  2. calculateSimpleInterest라는 이름의 함수를 만들어 사용하도록 프로그램을 수정해보자. 이 함수는 원금, 이율, 기간을 파라미터로 받으며 원리금을 반환한다.
  3. 기간 도래 후의 원리금만을 출력하는 대신 매년 원리금의 변화를 알 수 있도록 연단위로 원리금을 출력하도록 프로그램을 수정해보자
"""
